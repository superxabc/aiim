...
REQUEST_COUNT = Counter(
    "aiim_http_requests_total",
    "Total HTTP requests",
    ["method", "endpoint", "status"],
    registry=CUSTOM_REGISTRY,
)
REQUEST_DURATION = Histogram(
    "aiim_http_request_duration_seconds",
    "HTTP request duration",
    ["method", "endpoint"],
    registry=CUSTOM_REGISTRY,
)
ACTIVE_CONNECTIONS = Gauge(
    "aiim_websocket_connections_active",
...
CALL_COUNT = Counter(
    "aiim_calls_total", "Total calls processed", ["status"], registry=CUSTOM_REGISTRY
)
DB_QUERY_DURATION = Histogram(
    "aiim_db_query_duration_seconds",
...
SYSTEM_CPU_USAGE = Gauge(
    "aiim_system_cpu_usage_percent",
    "System CPU usage percentage",
    registry=CUSTOM_REGISTRY,
)
SYSTEM_MEMORY_USAGE = Gauge(
    "aiim_system_memory_usage_percent",
    "System memory usage percentage",
    registry=CUSTOM_REGISTRY,
)
SYSTEM_DISK_USAGE = Gauge(
    "aiim_system_disk_usage_percent",
    ...
    async def check_redis() -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "response_time": duration,
                "details": (
                    "Redis connection successful" if pong else "Redis ping failed"
                ),
            }
        except Exception as e:
            return {
    ...
    def check_system_resources() -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "status": (
                    "healthy"
                    if all([cpu_percent < 90, memory_percent < 90, disk_percent < 90])
                    else "warning"
                ),
            }
        except Exception as e:
...
class LoggingConfig:
    ...
    def setup_logging():
        ...
        config = {
            ...
            "loggers": {
                "aiim": {"level": "DEBUG", "handlers": ["file"], "propagate": False},
                "uvicorn.access": {
                    "level": "INFO",
                    "handlers": ["file"],
                    "propagate": False,
